...
**Speculative Attractiveness of ”Shoe-string” Common stocks Considered.** Our discussion of fixed-value investment has emphasized as strongly as possible the disadvantage (amounting to unfairness) that attaches to the senior security holder‘s position where the junior capital is proportionately slight.
